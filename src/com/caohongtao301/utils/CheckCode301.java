...
/** 
* @ClassName: CheckCode301 
* @Description: TODO(other) 
* @author 曹洪涛
* @date 2021-11-28 20:23:42 
*  
*/
@WebServlet("/CheckCode301")
public class CheckCode301 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 7.将随机数存在session中
		request.getSession().setAttribute("CHECKCODE_SERVER", random);
